import { FiScissors, FiAward, FiHeart, FiUsers } from "react-icons/fi";
    ...
    <section className="bg-black px-5 py-20 text-white sm:px-6 sm:py-24 lg:px-8 lg:py-28">
      ...
      >
        <div className="relative mx-auto w-full max-w-xl lg:mx-0 lg:min-h-[600px]">
          <motion.div
            variants={fadeUp}
            className="hidden overflow-hidden rounded-2xl border border-white/10 lg:absolute lg:left-0 lg:top-0 lg:block lg:h-[420px] lg:w-[330px]"
          >
            <img
          ...
          <motion.div
            variants={fadeUp}
            className="relative z-10 h-[360px] w-full overflow-hidden rounded-2xl border border-white/10 sm:h-[450px] lg:ml-40 lg:mt-28 lg:h-[500px] lg:max-w-[420px]"
          >
            <img
        ...
        <div>
          <motion.div variants={fadeUp} className="mb-6 inline-flex rounded-full border border-[#D4A85A]/30 bg-[#D4A85A]/10 px-5 py-2.5 sm:mb-8 sm:px-6 sm:py-3">
            <p className="text-xs font-medium uppercase tracking-[0.22em] text-[#D4A85A] sm:text-sm">
              Our Story
            </p>
          </motion.div>

          <motion.h2 variants={fadeUp} className="max-w-2xl text-[2.4rem] font-bold leading-[1.05] sm:text-5xl lg:text-6xl">
            A Legacy of
          ...
          <motion.div
            variants={containerVariants}
            className="mt-10 grid gap-5 sm:grid-cols-2 lg:mt-12 lg:gap-6"
          >
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  <Icon aria-hidden="true" className="text-3xl text-[#D4A85A] sm:text-4xl" />
